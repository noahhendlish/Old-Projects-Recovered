...
/*  51 */       appendValueList("[", ", ", "]", new ArrayIterator(value));
/*     */     } else {
/*  53 */       append('<');
...
/*     */   {
/*  71 */     return appendValueList(start, separator, end, Arrays.asList(values));
/*     */   }
/*     */   
...
/*  80 */     return appendList(start, separator, end, new SelfDescribingValueIterator(values));
/*     */   }
/*     */   
...
/*  94 */       appendDescriptionOf((SelfDescribing)i.next());
/*  95 */       separate = true;
/*     */     }
/*  97 */     append(end);
/*     */     
...
/* Location:              /Users/noahhendlish/Documents/workspace/Project1/togive/rover17.jar!/org/hamcrest/BaseDescription.class
